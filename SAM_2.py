...
class verificação():
    ...
    def tabela_dinâmica_new_sheet(self):
        ...
        if 'File_name' in col_fornecedor:
            self.indice_filename = col_fornecedor.index('File_name') + 1
            ...
            for i in range(2, self.count_row_new_ws):
                ...
                if i==2:
                    ...
                    try: 
                        ...
                        print(f'Error: list index out range. ID: {id1} ou {id2}')
        ...
        elif 'Valores_faturados Valor' in col_fornecedor: 
            self.indice_vl_faturado_col = col_fornecedor.index('Valores_faturados Valor') + 1
            indice_auditoria = 0
            for i in range(2, self.count_row_new_ws):
                Faturado_string = self.ws_new_fornecedor.cell(row = i, column = self.indice_vl_faturado_col).value    
